...
## 1) Setting Up mitmweb
1. Start mitmweb to listen on port `8080`.
```
mitmweb
```

## 2) Capturing and Saving Requests
...
## 3) Generating the Open API Documentation
...
## 4) Validation and Importation into Postman
